...
public class JFMateria extends javax.swing.JFrame {
   ...
   int xx, xy;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/bok.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFMateria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
